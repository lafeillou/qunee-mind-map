...
var graphs = {
    "expand.svg": {
        draw: function(ctx) {
            ctx.save();
            ctx.fillStyle = "#E21667";
            ctx.beginPath();
            ctx.moveTo(28, 25);
            ctx.lineTo(40, 25);
            ctx.quadraticCurveTo(40, 25, 40, 25);
            ctx.lineTo(40, 37);
            ctx.quadraticCurveTo(40, 37, 40, 37);
            ctx.lineTo(28, 37);
            ctx.quadraticCurveTo(28, 37, 28, 37);
            ctx.lineTo(28, 25);
            ctx.quadraticCurveTo(28, 25, 28, 25);
            ctx.closePath();
            ctx.fill();
            ctx.restore();
            ctx.save();
    ...
    "collapse.svg": {
        draw: function(ctx) {
            ...
            ctx.lineTo(55, 37);
            ctx.quadraticCurveTo(55, 37, 55, 37);
            ctx.lineTo(43, 37);
            ctx.quadraticCurveTo(43, 37, 43, 37);
            ctx.lineTo(43, 25);
            ctx.quadraticCurveTo(43, 25, 43, 25);
            ctx.closePath();
            ctx.fill();
            ctx.restore();
            ctx.save();
            ...
            ctx.moveTo(45, 30);
            ctx.lineTo(53, 30);
            ctx.quadraticCurveTo(53, 30, 53, 30);
            ctx.lineTo(53, 32);
            ctx.quadraticCurveTo(53, 32, 53, 32);
            ctx.lineTo(45, 32);
            ctx.quadraticCurveTo(45, 32, 45, 32);
            ctx.lineTo(45, 30);
            ctx.quadraticCurveTo(45, 30, 45, 30);
            ctx.closePath();
            ctx.fill();
            ctx.restore();
        }
    ...
    "error.svg": {
        draw: function(ctx) {
            ...
            ctx.moveTo(13, 25);
            ctx.lineTo(25, 25);
            ctx.quadraticCurveTo(25, 25, 25, 25);
            ctx.lineTo(25, 37);
            ctx.quadraticCurveTo(25, 37, 25, 37);
            ctx.lineTo(13, 37);
            ctx.quadraticCurveTo(13, 37, 13, 37);
            ctx.lineTo(13, 25);
            ctx.quadraticCurveTo(13, 25, 13, 25);
            ctx.closePath();
            ctx.fill();
            ctx.restore();
            ctx.save();
            ...
            ctx.moveTo(18, 27);
            ctx.lineTo(20, 27);
            ctx.quadraticCurveTo(20, 27, 20, 27);
            ctx.lineTo(20, 32);
            ctx.quadraticCurveTo(20, 32, 20, 32);
            ctx.lineTo(18, 32);
            ctx.quadraticCurveTo(18, 32, 18, 32);
            ctx.lineTo(18, 27);
            ctx.quadraticCurveTo(18, 27, 18, 27);
            ctx.closePath();
            ctx.moveTo(18, 33);
            ctx.lineTo(20, 33);
            ctx.quadraticCurveTo(20, 33, 20, 33);
            ctx.lineTo(20, 35);
            ctx.quadraticCurveTo(20, 35, 20, 35);
            ctx.lineTo(18, 35);
            ctx.quadraticCurveTo(18, 35, 18, 35);
            ctx.lineTo(18, 33);
            ctx.quadraticCurveTo(18, 33, 18, 33);
            ctx.closePath();
            ctx.fill();
            ctx.restore();
        }
    ...
    "pending.svg": {
        draw: function(ctx) {
            ...
            ctx.moveTo(28, 10);
            ctx.lineTo(40, 10);
            ctx.quadraticCurveTo(40, 10, 40, 10);
            ctx.lineTo(40, 22);
            ctx.quadraticCurveTo(40, 22, 40, 22);
            ctx.lineTo(28, 22);
            ctx.quadraticCurveTo(28, 22, 28, 22);
            ctx.lineTo(28, 10);
            ctx.quadraticCurveTo(28, 10, 28, 10);
            ctx.closePath();
            ctx.fill();
            ctx.restore();
            ctx.save();
    ...
    "loading.svg": {
        draw: function(ctx) {
            ...
            ctx.moveTo(13, 10);
            ctx.lineTo(25, 10);
            ctx.quadraticCurveTo(25, 10, 25, 10);
            ctx.lineTo(25, 22);
            ctx.quadraticCurveTo(25, 22, 25, 22);
            ctx.lineTo(13, 22);
            ctx.quadraticCurveTo(13, 22, 13, 22);
            ctx.lineTo(13, 10);
            ctx.quadraticCurveTo(13, 10, 13, 10);
            ctx.closePath();
            ctx.fill();
            ctx.restore();
            ctx.save();
            ...
            ctx.moveTo(15, 15);
            ctx.lineTo(17, 15);
            ctx.quadraticCurveTo(17, 15, 17, 15);
            ctx.lineTo(17, 17);
            ctx.quadraticCurveTo(17, 17, 17, 17);
            ctx.lineTo(15, 17);
            ...
            ctx.moveTo(18, 15);
            ctx.lineTo(20, 15);
            ctx.quadraticCurveTo(20, 15, 20, 15);
            ctx.lineTo(20, 17);
            ctx.quadraticCurveTo(20, 17, 20, 17);
            ctx.lineTo(18, 17);
            ctx.quadraticCurveTo(18, 17, 18, 17);
            ctx.lineTo(18, 15);
            ctx.quadraticCurveTo(18, 15, 18, 15);
            ctx.closePath();
            ctx.moveTo(21, 15);
            ctx.lineTo(23, 15);
            ctx.quadraticCurveTo(23, 15, 23, 15);
            ctx.lineTo(23, 17);
            ctx.quadraticCurveTo(23, 17, 23, 17);
            ctx.lineTo(21, 17);
            ctx.quadraticCurveTo(21, 17, 21, 17);
            ctx.lineTo(21, 15);
            ctx.quadraticCurveTo(21, 15, 21, 15);
            ctx.closePath();
            ctx.fill();
            ctx.restore();
        }
